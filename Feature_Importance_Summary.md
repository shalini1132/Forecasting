...
1. **Lag-1** – Highest influence. Yesterday’s energy usage strongly affects tomorrow's usage.  
2. **Lag-2** – Moderate impact. Two-day lag helps capture short-term trends.  
...
- force_plot_sample.png`
- Notebook: LSTM_SHAP_Forecasting.ipynb`
